...
//                .accessTokenValiditySeconds(600_000_000);
    ...
    public ClientDetailsService jdbcClientService() throws Exception {
        JdbcClientDetailsServiceBuilder clientDetailsService = new JdbcClientDetailsServiceBuilder();
        clientDetailsService.dataSource(dataSource)
        //.passwordEncoder(PasswordEncoderFactories.createDelegatingPasswordEncoder());
        //.passwordEncoder(new BCryptPasswordEncoder());
        ;
        return clientDetailsService.build();
    }
